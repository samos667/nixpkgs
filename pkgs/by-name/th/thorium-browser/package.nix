...
stdenv.mkDerivation rec {
  ...
  instructionSet = "AVX2"; # AVX2, SSE3 or SSE4 CF: https://github.com/Alex313031/thorium/releases/tag/M126.0.6478.231 I think AVX2 is the best choice for default ?

  src = fetchurl {
    url = "https://github.com/Alex313031/thorium/releases/download/M${version}/thorium-browser_${version}_${instructionSet}.deb";
